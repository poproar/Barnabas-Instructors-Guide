...
![fig 3.10](fig-insert_new_element.png){:class="image right"}
...
![fig 3.13](fig-head_choice.png){:class="image right"} Using the same process as before, insert the head that you want
##### Insert one head
{:style="overflow: hidden;"}
