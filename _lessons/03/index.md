...
3. Move the location of the text.
  ...
  * L-CLICK on one of the 4 blue corners (they are kinda small, you might need to zoom in) of the rectangle around the B and drag the blue rectangle up and down ![fig 3.8](fig-3_8.jpg){:class="image center-block"}
...
4. Change the text.
  ...
  * R-CLICK on the “B” again and L-CLICK on “Edit Text”
  ![fig 3.9](fig-3_9.jpg){:class="image center-block"}
  {:style="overflow: hidden;"}
