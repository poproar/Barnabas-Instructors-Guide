...
Have the students make a step by step checklist on how to connect the Barnabas-Bot to the computer in explicit detail. The checklist should look something like the following:
...
Once your students have the LED blinking challenge them to change the numbers inside the delay block and identify how that changes the behavior of the LED. Challenge the students to find the smallest delay where they can still see the LED blink.
________________
